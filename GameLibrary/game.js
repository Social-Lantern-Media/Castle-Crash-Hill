...
var System = function (updateFPS, canvasID) {
    ...
    this.init = function (updateFPS, canvasID) {
        ...
        [
			...
			{ name: "S_TRACK", path: "media/Sounds/soundtrack.mp3", multichannel:true, volume: 0.3 }
        ]);
        ...
        //input commands called from the dom
            restart: function () {
                ...
                game.system.unload(); //clean up any game information
                 game.system.soundmanager.stop("S_TRACK");
                game.system = new System(30, 'game_canvas');
				game.system.soundmanager.play("S_TRACK");
            ...
            exit: function () {
             ...
             post = false; 
                if (post == false) {
                 window.open("https://twitter.com/intent/tweet?url=http://sociallanternmedia.weebly.com/&text= I+just+protected+the+castle+playing+Castle+Hill+Challenge !", "_blank");
                  post = true; 
                }
