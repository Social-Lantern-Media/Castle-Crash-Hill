...
(function (window) {
    ...
    var UI = function () {
        ...
        this.framesize = [{ x: 211, y: 112, srcX: 0, srcY: 0 }, //Flags
            { x: 213, y: 110, srcX: 0, srcY: 112 }, //Hiker Counter
        ...
        this.uipos = [{ x: 10, y: 10 }, //Flags
            ...
            { x: 5, y: 290 }]; //coin spread
            
             this.uipos1 = [{ x: 40, y: 70 }]; //coin spread
        ...
        this.init = function () {
			...
			//this.gamecoin_img =this.loadimg('media/coin.png');  
        ...
        this.draw = function () {
            if (this.isLoaded === true) {
                ...
                if (game.system.state === 'gameover') {
                  ...
                  // this.frames[1].draw(this.uipos1[1].x, this.uipos1[1].y, this.gamecoin_img, 0, false, this.scale[1]);

				
			//	emitter = game.add.emitter( this.frames[1].draw(this.uipos1[1].x, this.uipos1[1].y, this.gamecoin_img, 0, false, this.scale[1]));
              //  emitter.makeParticles(this.gamecoin_img);
